...
pub mod system_domain {
    ...
    pub fn development_config() -> ChainSpec {
        ChainSpec::from_genesis(
            ...
            ChainSpecExtensions {
                execution_chain_spec: super::core_payments::development_config(),
            },
        )
    }
    ...
    pub fn local_testnet_config() -> ChainSpec {
        ChainSpec::from_genesis(
            ...
            // Extensions
            ChainSpecExtensions {
                execution_chain_spec: super::core_payments::local_testnet_config(),
            },
        )
    }
    ...
    pub fn gemini_3b_config() -> ChainSpec {
        ChainSpec::from_genesis(
            ...
            Some(chain_spec_properties()),
            // Extensions
            ChainSpecExtensions { execution_chain_spec: super::core_payments::gemini_3b_config() },
        )
    }
