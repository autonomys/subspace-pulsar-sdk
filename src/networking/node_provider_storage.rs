    ...
    PersistentProviderStorage: ProviderStorage,
{
    pub(crate) fn new(
        ...
        // TODO: Transitional upgrade code, should be removed in the future; this is
        // because we no  longer persist locally provided records
        ...
        Self { local_peer_id, implicit_provider_storage, persistent_provider_storage }
    }
}
